...
import com.iotbackend.app.envc.messages.exceptions.NoMessageTreatmentFunctionException;
...
public class DefaultMqttMessageListener implements IMqttMessageListener {
	...
	public void messageArrived(String topic, MqttMessage message) throws Exception {
		logger.debug("The message {} just arrived at topic {} ", message.toString(), topic);
